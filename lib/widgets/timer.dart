...
class TimerWidget extends StatefulWidget {
  ...
  const TimerWidget({Key key ,   @required TimerState timerState,  @required NoteProvider myProvider,    @required ThemeProvider themeProvider}) : _timerState = timerState,_myProvider = myProvider, _themeProvider = themeProvider,super(key: key);
...
class _TimerWidgetState extends State<TimerWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    double SizeY = MediaQuery.of(context).size.width;
        ...
        var _myProvider = widget._myProvider;
        var _themeProvider = widget._themeProvider;
        var _timerState = widget._timerState;
