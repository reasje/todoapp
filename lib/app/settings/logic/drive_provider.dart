...
Future<void> upload(drive.DriveApi driveApi, drive.File driveFile, LazyBox<Note> noteBox, String uploadiung, String downloadDone,
...
Future<void> login(bool command, BuildContext context) async {
  ...
  if (noteBox.isEmpty && command != false) {
    showAlertDialog(context, id: "noNotes");
  } else {
    if (!_connState.is_conn) {
      ...
      if (_signInProvider.isSignedin) {
          ...
          try {
            ...
            if (command) {
              if (fileId == null) {
                ...
                showAlertDialog(context, id: "up", driveApi: driveApi, driveFile: driveFile, noteBox: noteBox, fileId: fileId);
              }
            } else {
              ...
              if (fileId == null) {
                ...
                // show continue dialog
                showAlertDialog(context, id: "down", driveApi: driveApi, driveFile: driveFile, noteBox: noteBox, fileId: fileId);
              }
            }
          } catch (err) {
            print("err : $err");
        ...
        showAlertDialog(context, id: "signIn");
      }
    }
  }
}

Future<String> checkFileExistence(drive.DriveApi driveApi) async {
  // file id
  String fileId = null;
