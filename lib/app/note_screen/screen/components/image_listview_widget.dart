  ...
  Widget build(BuildContext context) {
    ...
    return Container(
        ...
        child: ScrollConfiguration(
          ...
          child: Consumer3<ThemeProvider, NoteImageProvider, BottomNavProvider>(
              builder: (ctx, _themeProvider, _noteImageProvider, _bottomNavProvider, _) {
            return GridView.builder(
                gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                    crossAxisCount: 2, childAspectRatio: 0.8, mainAxisSpacing: h * 0.05, crossAxisSpacing: w * 0.03),
                scrollDirection: Axis.vertical,
                itemCount: _noteImageProvider.imageList != null ? _noteImageProvider.imageList.length + 1 : 1,
                itemBuilder: (context, index) {
                  if (index == (_noteImageProvider.imageList != null ? _noteImageProvider.imageList.length : 0)) {
                    return Container();
                  } else {
                              ...
                              child: GridTile(
                                ...
                                child: Center(
                                  child: Container(
                                      ...
                                      child: _noteImageProvider.imageList != null
                                          ? ClipRRect(
